...
export function About() {
  ...
  const defaultInfo = {
    ...
    experienceCards: [{"icon":"briefcase","title":"한국토지주택공사","period":"20년이 넘었네요","description":"현) 과천권 보상업무"},{"icon":"graduation","title":"이화여자대학교","period":"1997 - 2001","description":"경영학"},{"icon":"award","title":"한국공인회계사","period":"2003","description":"설명을 입력하세요"}],
